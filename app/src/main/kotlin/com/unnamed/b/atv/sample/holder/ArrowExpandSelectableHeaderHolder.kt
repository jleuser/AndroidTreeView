 ...
 */
class ArrowExpandSelectableHeaderHolder(context: Context) : BaseNodeViewHolder<IconTreeItemHolder.IconTreeItem>(context) {
    ...
    override fun createNodeView(node: TreeNode, value: IconTreeItemHolder.IconTreeItem): View {
        ...
        arrowView!!.setOnClickListener { treeView!!.toggleNodeExpansion(node) }
