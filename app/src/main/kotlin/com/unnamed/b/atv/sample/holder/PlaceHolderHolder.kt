 ...
 */
class PlaceHolderHolder(context: Context) : BaseNodeViewHolder<PlaceHolderHolder.PlaceItem>(context) {
    ...
    override fun createNodeView(node: TreeNode, value: PlaceItem): View {
        ...
        val placeName = view.findViewById<View>(R.id.place_name) as TextView
        placeName.text = value.name

        val r = Random()
        val like = r.nextBoolean()

        val likeView = view.findViewById<View>(R.id.like) as PrintView
