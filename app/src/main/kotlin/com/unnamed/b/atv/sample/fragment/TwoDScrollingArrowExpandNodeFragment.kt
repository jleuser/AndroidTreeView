 ...
 */
class TwoDScrollingArrowExpandNodeFragment : Fragment(), TreeNode.TreeNodeClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fillFolder(s1)
        val nodeToExpand = fillFolder(s2)
        ...
        tView!!.setDefaultNodeClickListener(this@TwoDScrollingArrowExpandNodeFragment)
    ...
    private fun fillFolder(folder: TreeNode): TreeNode {
        var currentNode = folder
        var file: TreeNode? = null
        for (i in 0..5) {
            file = TreeNode(IconTreeItemHolder.IconTreeItem(R.string.ic_folder, "$NAME $i"))
