 ...
 */
class SocialViewHolder(context: Context) : BaseNodeViewHolder<SocialViewHolder.SocialItem>(context) {
    ...
    override fun createNodeView(node: TreeNode, value: SocialItem): View {
        ...
        val connectionsLabel = view.findViewById<View>(R.id.connections) as TextView
        val r = Random()
        connectionsLabel.text = r.nextInt(150).toString() + " connections"

        val userNameLabel = view.findViewById<View>(R.id.username) as TextView
        userNameLabel.text = NAMES[r.nextInt(4)]

        val sizeText = view.findViewById<View>(R.id.size) as TextView
